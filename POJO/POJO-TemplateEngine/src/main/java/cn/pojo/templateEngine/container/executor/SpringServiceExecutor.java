package cn.pojo.templateEngine.container.executor;

import cn.pojo.annotations.ParamInfo;
import cn.pojo.exception.ParamInfoException;
import cn.pojo.templateEngine.container.ServiceExecutor;
...
import cn.pojo.user.base.InnerCookie;
import cn.pojo.user.base.UserUtil;
...
public class SpringServiceExecutor implements ServiceExecutor {
    ...
    public SpringServiceExecutor() {
        CacheLoader loader = new CacheLoader() {
            ...
            public SpringServiceExecutor.ServiceInfo load(String key) throws Exception {
                ...
                if(Iterables.size(parts) != 2) {
                    ...
                    if(method == null) {
                        ...
                        return new SpringServiceExecutor.ServiceInfo(klass, method, types, names);
                    }
                }
            }
    ...
    public Object exec(String api, Map<String, Object> params) {
        if(Strings.isNullOrEmpty(api)) {
            ...
            try {
                SpringServiceExecutor.ServiceInfo e = (SpringServiceExecutor.ServiceInfo)this.serviceInfos.getUnchecked(api);
