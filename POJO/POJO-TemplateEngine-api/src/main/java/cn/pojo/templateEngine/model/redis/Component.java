package cn.pojo.templateEngine.model.redis;
...
public class Component implements Serializable {
    ...
    public static enum CodeType {
        ...
        public static Component.CodeType fromNumber(int value) {
            Component.CodeType[] arr$ = values();
            int len$ = arr$.length;

            for(int i$ = 0; i$ < len$; ++i$) {
                Component.CodeType type = arr$[i$];
    ...
    public static enum CacheBy {
        ...
        public static Component.CacheBy fromNumber(int value) {
            Component.CacheBy[] arr$ = values();
            int len$ = arr$.length;

            for(int i$ = 0; i$ < len$; ++i$) {
                Component.CacheBy type = arr$[i$];
                if(type.value == value) {
                    return type;
                }
            }
